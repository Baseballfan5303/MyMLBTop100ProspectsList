...
#Load in datasets
batting <- read.csv(
  "C:\\Users\\schei\\OneDrive\\Desktop\\Data Analytics\\MLB Top 100 Prospects List\\batting.csv"
)
pitching <- read.csv(
  "C:\\Users\\schei\\OneDrive\\Desktop\\Data Analytics\\MLB Top 100 Prospects List\\pitching.csv"
)
options(scipen=200)
...
finalList <- read.csv(
  "C:\\Users\\schei\\OneDrive\\Desktop\\Data Analytics\\MLB Top 100 Prospects List\\Data and R Output\\top100csv.csv"
)
finalList[, "Org"] <- NA
finalList[, "Pos"] <- NA
...
#reload in datasets
batting2 <- read.csv(
  "C:\\Users\\schei\\OneDrive\\Desktop\\Data Analytics\\MLB Top 100 Prospects List\\Data and R Output\\batting.csv"
)
pitching2 <- read.csv(
  "C:\\Users\\schei\\OneDrive\\Desktop\\Data Analytics\\MLB Top 100 Prospects List\\Data and R Output\\pitching.csv"
)
...
#write.csv(finalList, "C:\\Users\\schei\\OneDrive\\Desktop\\Data Analytics\\MLB Top 100 Prospects List\\Data and R Output\\top100csv.csv")
